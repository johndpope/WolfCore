...
let sqliteStatic = unsafeBitCast(0, to: sqlite3_destructor_type.self) // swiftlint:disable:this variable_name
let sqliteTransient = unsafeBitCast(-1, to: sqlite3_destructor_type.self) // swiftlint:disable:this variable_name
